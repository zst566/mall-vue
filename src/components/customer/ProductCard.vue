  ...
  >
    ...
    <div class="product-image">
      ...
      <div class="product-badges">
        ...
        <div v-if="product.discount > 0" class="badge discount">
          {{ product.discount }}折
        </div>
        <div v-if="product.isNew" class="badge new">
          新品
        </div>
        <div v-if="product.stock <= 10 && product.stock > 0" class="badge limited">
          剩余{{ product.stock }}件
        </div>
        <div v-if="product.stock <= 0" class="badge sold-out">
          已售罄
        </div>
      </div>
    ...
    <div class="product-info">
      ...
      <div class="price-section">
        <div class="current-price">
          ...
          <span v-if="product.originalPrice && product.originalPrice > product.price" class="unit">起</span>
        </div>
