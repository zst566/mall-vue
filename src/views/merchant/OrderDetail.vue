      ...
      <div class="shipping-info-section">
        ...
        <div class="address-card">
          ...
          <div class="address-detail">
            {{ orderInfo.shippingAddress.province }}{{ orderInfo.shippingAddress.city }}{{ orderInfo.shippingAddress.district }}{{ orderInfo.shippingAddress.detail }}
          </div>
        </div>
      </div>
...
const canRefund = computed(() => {
  return ['confirmed', 'shipped'].includes(orderInfo.value.status) && orderInfo.value.paymentStatus === 'paid'
})
