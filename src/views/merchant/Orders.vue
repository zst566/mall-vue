      ...
      <div class="filter-popup">
        ...
        <van-form @submit="onFilterSubmit">
          ...
          <div class="filter-actions">
            <van-button block type="primary" @click="onFilterSubmit">
              应用筛选
            </van-button>
...
const statusOptions = [
  { text: '全部', value: '' },
  { text: '待核销', value: 'pending_verification' },
  { text: '已核销', value: 'verified' },
...
const loadOrders = async () => {
  ...
  try {
    const params = {
      ...
      dateRange: filterParams.dateRange.length > 0 ? {
        startDate: filterParams.dateRange[0],
        endDate: filterParams.dateRange[1]
      } : undefined
    }

    const response = await merchantService.getMerchantOrders(params)
